...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "کارخانه سیگل | نبات زعفرانی، زعفران ایرانی و شیرینی سنتی — Sigol Factory" },
      ...
      { name: "keywords", content: "نبات, نبات زعفرانی, زعفران, زعفران ایرانی, شیرینی, شیرینی سنتی, آبنبات, نبات چوبی, صادرات نبات, کارخانه سیگل, Sigol, saffron, Persian rock candy, Iranian saffron, nabat" },
      { name: "author", content: "Sigol Factory — کارخانه سیگل" },
      { property: "og:title", content: "کارخانه سیگل | نبات زعفرانی و زعفران ایرانی — Sigol Factory" },
      ...
      { property: "og:site_name", content: "Sigol Factory — کارخانه سیگل" },
