...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "کارخانه سی گل | نبات زعفرانی، زعفران ایرانی و شیرینی سنتی — Sigol Factory" },
      { name: "description", content: "کارخانه سی گل، تولیدکننده تخصصی نبات زعفرانی، زعفران ایرانی و شیرینی سنتی با کیفیت صادراتی به بیش از ۲۸ کشور. Premium Iranian saffron rock candy (Nabat), saffron and traditional confectionery for global export, private label & OEM partners." },
      { name: "keywords", content: "نبات, نبات زعفرانی, زعفران, زعفران ایرانی, شیرینی, شیرینی سنتی, آبنبات, نبات چوبی, صادرات نبات, کارخانه سی گل, Sigol, saffron, Persian rock candy, Iranian saffron, nabat" },
      { name: "author", content: "Sigol Factory — کارخانه سی گل" },
      { property: "og:title", content: "کارخانه سی گل | نبات زعفرانی و زعفران ایرانی — Sigol Factory" },
      ...
      { property: "og:site_name", content: "Sigol Factory — کارخانه سی گل" },
