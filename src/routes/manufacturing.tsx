...
export const Route = createFileRoute("/manufacturing")({
  head: () => ({
    meta: [
      { title: "فرآیند تولید نبات زعفرانی و شیرینی سنتی | کارخانه سی گل — Manufacturing" },
      { name: "description", content: "خط تولید مدرن نبات زعفرانی، نبات چوبی و شیرینی سنتی سی گل از زعفران خام تا کارتن صادراتی، با رعایت استانداردهای ISO 22000 و HACCP. Modern Persian confectionery manufacturing from raw saffron to export-ready cartons." },
      ...
      { property: "og:title", content: "فرآیند تولید نبات زعفرانی سی گل — Sigol Manufacturing" },
        ...
        <ol className="mt-16 relative border-s-2 border-[color:var(--saffron)]/30 ps-8 space-y-10">
          {steps.map(([k, d], i) => (
            <li key={k} className="relative">
              ...
              <h3 className="font-display text-xl md:text-2xl font-extrabold">{t(k)}</h3>
